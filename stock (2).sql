...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2019 at 06:02 PM
...
INSERT INTO `orders` (`order_id`, `order_date`, `client_name`, `client_contact`, `address`, `sub_total`, `vat`, `total_amount`, `discount`, `grand_total`, `paid`, `due`, `payment_type`, `payment_status`, `order_status`) VALUES
...
INSERT INTO `product` (`product_id`, `product_name`, `product_image`, `brand_id`, `user_id`, `categories_id`, `quantity`, `rate`, `unit`, `active`, `status`) VALUES
(1, 'Half pant', '', 1, 2, 2, '19', '1500', 'kg', 2, 2),
(2, 'T-Shirt', '', 2, 2, 2, '9', '1200', 'kg', 2, 2),
(3, 'Half Pant', '', 5, 2, 3, '18', '1200', 'kg', 2, 2),
(4, 'T-Shirt', '', 6, 2, 3, '29', '1000', 'kg', 2, 2);
...
(1, 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'abc@gmail.com', 1234567890),
(2, 'user', 'user', 'user@gmail.com', 1234567890);
